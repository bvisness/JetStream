...
samply record --save-only -o sm-perf.data -r 10000 $SM_SHELL $SM_OPTS cli.js $TEST

V8_OPTS="--perf-prof --interpreted-frames-native-stack --allow-natives-syntax --no-turbo-inlining --no-maglev-inlining"
samply record --save-only -o v8-perf.data -r 10000 $V8_SHELL $V8_OPTS cli.js -- $TEST
